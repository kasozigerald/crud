...
if($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    if(empty($name_err) && empty($address_err) && empty($marks_err)){
        ...
        if($stmt = $mysqli->prepare($sql)){
            ...
            $stmt->bind_param("sss", $param_name, $param_address, $param_marks);
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($marks_err)) ? 'has-error' : ''; ?>">
                            <label>Marks</label>
                            <input type="text" name="marks" class="form-control" value="<?php ?>">
                            <span class="text-danger"><?php echo $marks_err;?></span>
                        </div>
